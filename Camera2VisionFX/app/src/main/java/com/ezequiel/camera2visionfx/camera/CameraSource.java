...
public class CameraSource {
     ...
     *
     * @param surfaceTexture the surface texture to use for the preview frames
     * @throws IOException if the supplied surface texture could not be used as the preview display
     */
    @RequiresPermission(Manifest.permission.CAMERA)
    public CameraSource start(SurfaceTexture surfaceTexture, GraphicOverlay gro) throws IOException {
        synchronized (mCameraLock) {
            if (mCamera != null) {
                return this;
            }
            try {
                ...
                gro.setCameraInfo(mPreviewSize.getHeight()/4, mPreviewSize.getWidth()/4, mFacing);

            } catch (RuntimeException e) {
                e.printStackTrace();
                //todo: camera error callback
                return null;
            }
        }
        return this;
     ...
     * <p/>
     * This camera source may be restarted again by calling {@link #start(SurfaceTexture, GraphicOverlay)}.
     * <p/>
    ...
    */
     ...
     * activated previously with {@link #start(SurfaceTexture, GraphicOverlay)}.  The camera preview is suspended
     ...
     * (between {@link #start(SurfaceTexture, GraphicOverlay)} and before {@link #stop()} or {@link #release()}).
     * <p/>
